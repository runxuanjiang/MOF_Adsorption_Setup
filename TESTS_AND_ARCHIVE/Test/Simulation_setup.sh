...
CELL_LEGNTH_A=$( awk '/^_cell_length_a/{print $2}' ${MOF_PWD} )
CELL_LENGTH_B=$( awk '/^_cell_length_b/{print $2}' ${MOF_PWD} )
CELL_LENGTH_C=$( awk '/^_cell_length_c/{print $2}' ${MOF_PWD} )
CELL_ANGLE_ALPHA=$( awk '/^_cell_angle_alpha/{print $2}' ${MOF_PWD} )
CELL_ANGLE_BETA=$( awk '/^_cell_angle_beta/{print $2}' ${MOF_PWD} )
CELL_ANGLE_GAMMA=$( awk '/^_cell_angle_gamma/{print $2}' ${MOF_PWD} )
PI=$( echo "4*a(1)" | bc -l )
...
sed -i "s/DD0/${RESERVOIR_DIM}/g" in.conf
sed -i "s/DD1/${BOX_0_VECTOR1}/g" in.conf
sed -i "s/DD2/${BOX_0_VECTOR2}/g" in.conf
sed -i "s/DD3/${BOX_0_VECTOR3}/g" in.conf
